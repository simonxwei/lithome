...
public final class LithomeManager {
    ...
    public LithomeManager(final NoiseLithomeSource noiseLithomeSource, final long seed) {
        this(noiseLithomeSource, BiomeManager.obfuscateSeed(seed ^ ZOOM_SEED_SALT), true);
    }

    private LithomeManager(final NoiseLithomeSource noiseLithomeSource, final long lithomeZoomSeed, final boolean ignored) {
    ...
    public Holder<Lithome> getLithome(final int blockX, final int blockY, final int blockZ) {
    ...
    public Selection getLithomeSelection(final int blockX, final int blockY, final int blockZ) {
        ...
        return new Selection(
            ...
            lithomeY,
            lithomeZ,
            this.noiseLithomeSource.lithome$getNoiseLithome(lithomeX, lithomeY, lithomeZ)
        );
    }
    ...
    public Holder<Lithome> getNoiseLithomeAtQuart(
        ...
        return this.noiseLithomeSource.lithome$getNoiseLithome(quartX, quartY, quartZ);
    }
